...
"""
After running modesl like pca, I believe some of the data is causing scewed results and should be removed.
Removed data: All stocks on the LSE and SGX and stocks features EPS and Average Volume.
"""
